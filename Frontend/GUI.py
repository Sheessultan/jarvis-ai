...
from PyQt5.QtWidgets import (
    ...
    QVBoxLayout, QHBoxLayout, QPushButton, QLabel, QSizePolicy, QFrame
)
...
def GetMicrophoneStatus():
    try:
        with open(TempFile("Mic.data"), "r", encoding="utf-8") as f:
            return f.read().strip()
    except:
        return "True"

# ✔ FIX: WRONG NAME COMPATIBILITY (IMPORTANT)
def SetAsssistantStatus(state):   # <-- keep THIS (for your main.py compatibility)
    with open(TempFile("Status.data"), "w", encoding="utf-8") as f:
        f.write(state)

# ✔ REAL FUNCTION ALSO PROVIDED (correct spelling)
...
class ChatSection(QWidget):
    def __init__(self):
        ...
        self.chat.setStyleSheet("background:black;color:white;font-size:14px;")
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("Jarvis GUI")
